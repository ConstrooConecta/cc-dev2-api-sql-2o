...
public class PagamentoServicoService {
    ...
    // crud
    public List<PagamentoServico> findAllPaymentsServices() { return pagamentoServicoRepository.findAll(); }
    @Transactional
    public PagamentoServico savePaymentService(PagamentoServico pagamentoServico) { return pagamentoServicoRepository.save(pagamentoServico); }
    @Transactional
    ...
    public List<PagamentoServico> findByServico(Integer servico) { return pagamentoServicoRepository.findByServico(servico); }
    public List<PagamentoServico> findByUsuario(String usuario) { return pagamentoServicoRepository.findByUsuario(usuario); }
    public List<PagamentoServico> findByTipoPagamento(String tipoPagamento) { return pagamentoServicoRepository.findByTipoPagamentoLikeIgnoreCase(tipoPagamento); }
    public List<PagamentoServico> findByDataPagamento(Date dataPagamento) { return pagamentoServicoRepository.findByDataPagamento(dataPagamento); }
}

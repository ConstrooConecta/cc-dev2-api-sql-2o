...
public class CategoriaController {
    ...
    @Operation(summary = "Delete a category", description = "Deletes the category with the specified categoriaId")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<?> deleteCategoryByCategoriaId ( @PathVariable Long categoriaId ) {
        categoriaService.deleteCategory(categoriaId);
        return ResponseEntity.ok("Categoria excluída com sucesso");
    }

    @PatchMapping("/update/{categoriaId}")
    @Operation(summary = "Update a category", description = "Updates the category data with the specified categoriaId")
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<?> updateCategory ( @Valid @PathVariable Long categoriaId,
                                          @RequestBody Map<String, Object> updates ) {
        try {
            Categoria categoria = categoriaService.findCategoriesById(categoriaId);
            if (updates.containsKey("nome") ) { categoria.setNome((String) updates.get("nome")); }
            ...
            return ResponseEntity.ok("A categoria com categoriaId " + categoriaId + " foi atualizada com sucesso.");
        } catch (DataIntegrityViolationException e) {
    ...
    @GetMapping("/findById/{categoriaId}")
    @Operation(summary = "Find category by categoriaId", description = "Returns the category with the specified categoriaId")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> findCategoriesById (@PathVariable Long categoriaId) {
        try {
            Categoria categoria = categoriaService.findCategoriesById(categoriaId);
            if (categoria == null) {
